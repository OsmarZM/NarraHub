...
```text
FASE 4 — Sync V2   (etapas 1 a 6 de 14 concluídas)
```
...
| Sync V2 | **ADR 0009 `Accepted`.** Etapas 1–6 concluídas — replica entre três peers em memória; falta transporte real, pareamento e **NH-053** |
