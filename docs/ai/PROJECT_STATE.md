...
```text
FASE 4 — Sync V2   (etapas 1 a 7 de 14 concluídas)
```
...
| Sync V2 | **ADR 0009 `Accepted`.** Etapas 1–7 concluídas — replicação verificada entre peers; falta transporte real, pareamento e o gate de saída **NH-053** |
