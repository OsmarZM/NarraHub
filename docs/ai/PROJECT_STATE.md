...
```text
FASE 4 — Sync V2   (etapas 1 a 8 de 14 concluídas)
```
...
| Sync V2 | **ADR 0009 `Accepted`.** Etapas 1–8 concluídas — protocolo e handshake prontos; falta rede real, pareamento e o gate de saída **NH-053** |
