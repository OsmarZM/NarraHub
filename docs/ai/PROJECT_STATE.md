...
```text
FASE 4 — Sync V2   (etapas 1, 2 e 2.5 de 14 concluídas)
```
...
| Sync V2 | **ADR 0009 `Accepted`.** Etapas 1, 2 e 2.5 concluídas — schema 16, log com causalidade e eventos assinados |
