...
pub const EFEITOS: &[EfeitoDeExclusao] = &[
    ...
    fk!("universes", "entity_templates"."universe_id" "CASCADE" => "entity_template", Delete, "B3", UNIVERSO_RECUSADO),
    ...
    fk!("stories", "planning_field_links"."story_id" "CASCADE" => "planning_item", Rewrite, "B4",
        "exclusão da história recusada enquanto houver card com a história num campo"),
    ...
    fk!("chapters", "planning_items"."chapter_id" "SET NULL" => "planning_item", Rewrite, "B4",
        "exclusão do capítulo recusada enquanto houver card ligado a ele"),
    ...
    // ── entity ────────────────────────────────────────────────────────────
    fk!("entities", "entity_attributes"."entity_id" "CASCADE" => "entity", Interno, "B3", "entity_service fora da Mutacao até B3"),
    fk!("entities", "relations"."source_id" "CASCADE" => "relation", Delete, "B3", "entity_service fora da Mutacao até B3"),
    fk!("entities", "relations"."target_id" "CASCADE" => "relation", Delete, "B3", "entity_service fora da Mutacao até B3"),
    fk!("entities", "timeline_events"."entity_id" "SET NULL" => "timeline_event", Rewrite, "B3", "entity_service fora da Mutacao até B3"),
    fk!("entities", "canvas_entity_positions"."entity_id" "CASCADE" => "canvas_entity_position", Delete, "B3", "entity_service fora da Mutacao até B3"),
    fk!("entities", "planning_field_links"."entity_id" "CASCADE" => "planning_item", Rewrite, "B4", "entity_service fora da Mutacao até B3; na B3 recusa enquanto houver link (B4)"),
    fk!("entities", "mentions"."entity_id" "CASCADE" => "—", Local, "fora do sync", "—"),
    gatilho!("entities", "trg_entity_attachments_delete", "attachments" => "attachment", Delete, "B3", "entity_service fora da Mutacao até B3"),
    gatilho!("entities", "trg_entity_metadata_delete", "content_tag_assignments" => "tag_assignment", Delete, "B3", "entity_service fora da Mutacao até B3"),
    gatilho!("entities", "trg_entity_metadata_delete", "content_custom_fields" => "entity", Interno, "B3", "entity_service fora da Mutacao até B3"),
    // ── timeline / planning ───────────────────────────────────────────────
    gatilho!("timeline_events", "trg_timeline_metadata_delete", "content_tag_assignments" => "tag_assignment", Delete, "B3", "fora da Mutacao até B3"),
    fk!("planning_items", "planning_field_links"."planning_item_id" "CASCADE" => "planning_item", Interno, "B4", "planning_service fora da Mutacao até B4"),
    fk!("planning_items", "planning_field_definitions"."owner_item_id" "CASCADE" => "planning_field_definition", Delete, "B4", "planning_service fora da Mutacao até B4"),
    gatilho!("planning_items", "trg_planning_metadata_delete", "content_tag_assignments" => "tag_assignment", Delete, "B4", "planning_service fora da Mutacao até B4"),
    fk!("planning_field_definitions", "planning_field_links"."field_definition_id" "CASCADE" => "planning_item", Rewrite, "B4", "planning_service fora da Mutacao até B4"),
    gatilho!("planning_field_definitions", "trg_planning_field_definition_delete", "planning_items" => "planning_item", Rewrite, "B4", "planning_service fora da Mutacao até B4"),
    // ── tags ──────────────────────────────────────────────────────────────
