...
use database::migrations::{
    ...
    MIGRATION_V20, MIGRATION_V21, MIGRATION_V22, MIGRATION_V23, MIGRATION_V24, MIGRATION_V3,
            ...
            tauri_plugin_sql::Builder::default()
                .add_migrations(
                    ...
                    vec![
                        ...
                        Migration {
                            version: 16,
                            description: "Add Sync V2 replication structures",
                            sql: MIGRATION_V16,
                            kind: MigrationKind::Up,
                        },
                        Migration {
                            version: 17,
                            description: "Add causal coordinates to tombstones",
                            sql: MIGRATION_V17,
                            kind: MigrationKind::Up,
                        },
                        Migration {
                            version: 18,
                            description: "Divergence semantics and device exit coherence",
                            sql: MIGRATION_V18,
                            kind: MigrationKind::Up,
                        },
                        Migration {
